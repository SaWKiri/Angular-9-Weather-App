...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  function srcAppWeatherModuleInterceptorsConstDataTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "currentCondition", function () {
      return currentCondition;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "currentConditionTelAviv", function () {
      return currentConditionTelAviv;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "currentCondition3431644", function () {
      return currentCondition3431644;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "currentCondition325876", function () {
      return currentCondition325876;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "forcast", function () {
      return forcast;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "geoPositionSearchKriyatAtidim", function () {
      return geoPositionSearchKriyatAtidim;
    });
    ...
    var geoPositionSearchKriyatAtidim = {
      Version: 1,
      Key: '215805',
      Type: 'City',
      Rank: 95,
  ...
  /***/
  function srcAppWeatherModuleInterceptorsFakeBackEndInterceptorTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "FakeInterceptor", function () {
    ...
    var _constData__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./constData */
    "./src/app/weatherModule/interceptors/constData.ts");

    var FakeInterceptor = /*#__PURE__*/function () {
      function FakeInterceptor() {
        _classCallCheck(this, FakeInterceptor);

        this.baseUrl = 'dataservice.accuweather.com';
      }

      _createClass(FakeInterceptor, [{
        key: "intercept",
        value: function intercept(req, next) {
          ...
          if (req.url.includes('/cities/geoposition/search')) {
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpResponse"]({
              status: 200,
              body: _constData__WEBPACK_IMPORTED_MODULE_3__["geoPositionSearchKriyatAtidim"]
            }));
          }
          ...
          if (req.url.includes('/cities/autocomplete')) {
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpResponse"]({
              status: 200,
              body: _constData__WEBPACK_IMPORTED_MODULE_3__["autocomplete"]
            }));
          }
          ...
          if (req.url.includes('/daily/5day/')) {
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpResponse"]({
              status: 200,
              body: _constData__WEBPACK_IMPORTED_MODULE_3__["forcast"]
            }));
          }
          ...
          if (req.url.includes('/currentconditions/v1/') && req.url.includes('215805')) {
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpResponse"]({
              status: 200,
              body: _constData__WEBPACK_IMPORTED_MODULE_3__["currentConditionTelAviv"]
            }));
          }
          ...
          if (req.url.includes('/currentconditions/v1/') && req.url.includes('3431644')) {
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpResponse"]({
              status: 200,
              body: _constData__WEBPACK_IMPORTED_MODULE_3__["currentCondition3431644"]
            }));
          }
          ...
          if (req.url.includes('/currentconditions/v1/') && req.url.includes('3431644')) {
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpResponse"]({
              status: 200,
              body: _constData__WEBPACK_IMPORTED_MODULE_3__["currentCondition325876"]
            }));
          }
          ...
          if (req.url.includes('/currentconditions/v1/')) {
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpResponse"]({
              status: 200,
              body: _constData__WEBPACK_IMPORTED_MODULE_3__["currentCondition"]
            }));
          }
    ...
    FakeInterceptor.ɵfac = function FakeInterceptor_Factory(t) {
      return new (t || FakeInterceptor)();
    };

    FakeInterceptor.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
      token: FakeInterceptor,
      factory: FakeInterceptor.ɵfac
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](FakeInterceptor, [{
  ...
  function srcAppWeatherModuleInterceptorsIndexTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _fakeBackEnd_interceptor__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ./fakeBackEnd.interceptor */
    "./src/app/weatherModule/interceptors/fakeBackEnd.interceptor.ts");
    /* harmony import */


    var _httpErrorHandler_interceptor__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./httpErrorHandler.interceptor */
    "./src/app/weatherModule/interceptors/httpErrorHandler.interceptor.ts");

    var httpInterceptorProviders = [{
      provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HTTP_INTERCEPTORS"],
      useClass: _fakeBackEnd_interceptor__WEBPACK_IMPORTED_MODULE_1__["FakeInterceptor"],
      multi: true
    }, {
      provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HTTP_INTERCEPTORS"],
      useClass: _httpErrorHandler_interceptor__WEBPACK_IMPORTED_MODULE_2__["HttpErrorInterceptor"],
      multi: true
    }];
    /***/
  },
